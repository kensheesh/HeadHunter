...
//        return ResponseEntity.ok(vacancyService.getAllActiveVacancies(1, 1, "test"));
//    }
//
...
//        vacancyService.createVacancyForEmployer(vacancyDto, 1);
...
//        vacancyService.editVacancy(vacancyEditDto, id);
